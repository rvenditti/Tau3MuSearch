...
void ntupleClass_Control::Fill_particleName(TString pId[NPARTICLES]){
...
void ntupleClass_Control::Fill_particleId(Int_t pdgId, Int_t IdSummary[NPARTICLES]){
...
void ntupleClass_Control::Fill_particleId_2D(Int_t pdgId, Int_t pdgIdMother, Int_t IdSummary[NPARTICLES][NPARTICLES]){
