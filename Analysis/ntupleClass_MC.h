...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TBranch        *b_FlightDistPVSV_chi2;   //!
    ...
    virtual void     InitHistoStepByStep_Triplet(TH1D *hL1[NCUTS], TH1D *hPt_tripl[NCUTS], TH1D *hEta_tripl[NCUTS], TH1D *hPhi_tripl[NCUTS], TH1D *hMass_tripl[NCUTS]);
        // Other functions
