...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ntupleClass_Control(TTree *tree);
    ...
    virtual void     FillHistoAC(Int_t ind, Int_t mu[NTOT], TH1F *hChi2Track, TH1D *hNMatchedStat, TH1D *hFlightDist, TH1D *hFlightDist_Signif, TH2D *hFlightDistvsP, TH1D *hPtErrOverPt, TH1D *hmassdi, Double_t dimu[NTOT], TH1F *hmassQuad, TH1F *hmassQuad_Zero);
    ...
    virtual void     FillHistoSingleMu(Int_t mu_Ind[NTOT], Int_t mu[NTOT], TH1D *hist_pt, TH1D *hist_pt_mu[NTOT], TH1D *hist_eta, TH1D *hist_eta_mu[NTOT], TH1D *hist_phi, TH1D *hVx, TH1D *hVy, TH1D *hVz);
    ...
    virtual void     InitHistoStepByStep_SingleMu(TH1D *hPt[NCUTS], TH1D *hPt_mu[NCUTS][NTOT], TH1D *hEta[NCUTS], TH1D *hEta_mu[NCUTS][NTOT], TH1D *hPhi[NCUTS], TH1D *hVx[NCUTS], TH1D *hVy[NCUTS], TH1D *hVz[NCUTS]);
