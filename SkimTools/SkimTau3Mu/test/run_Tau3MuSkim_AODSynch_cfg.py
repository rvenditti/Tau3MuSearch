...
process.load("SkimTools.SkimTau3Mu.Tau3MuSkimAODForSync_cff")

#process.GlobalTag.globaltag = '94X_dataRun2_ReReco_EOY17_v6' #data2017
process.GlobalTag.globaltag = '92X_dataRun2_Prompt_v5' #why this old GT??
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        'root://xrootd-cms.infn.it///store/data/Run2017F/DoubleMuonLowMass/AOD/17Nov2017-v1/10000/EEC5ACC2-B802-E811-AF14-0CC47A0AD498.root'
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("histoSkimSynch2.root"))
...
process.out = cms.OutputModule("PoolOutputModule",
                               fileName = cms.untracked.string("testSynch2.root"),
