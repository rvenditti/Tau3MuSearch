...
void plot_BDT_inputvariables() 
{
   ...
   for(int i = 0; i<n; i++){
        ...
        leg->AddEntry(hdata_A[i],"2017 "+varname+" dataA","f");
        leg->AddEntry(hdata_B[i],"2017 "+varname+" dataB","f");
        leg->AddEntry(hdata_C[i],"2017 "+varname+" dataC","f");
        leg->Draw();
...
//        if(i==5) hmc_A[i]->GetXaxis()->SetRangeUser(-0.1, 5);
        ...
        leg2->AddEntry(hmc_A[i],"2017 "+varname+" mcA","f");
        leg2->AddEntry(hmc_B[i],"2017 "+varname+" mcB","f");
        leg2->AddEntry(hmc_C[i],"2017 "+varname+" mcC","f");
        leg2->Draw();
