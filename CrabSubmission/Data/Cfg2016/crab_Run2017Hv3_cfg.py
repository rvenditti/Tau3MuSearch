...
config.General.requestName = 'SkimTau3Mu_DoubleMuonLowMass_Run2016H_v3_v1'
...
config.Data.inputDataset = '/DoubleMuonLowMass/Run2016H-PromptReco-v3/AOD'
...
config.Data.outputDatasetTag = 'SkimTau3Mu_DoubleMuonLowMass_Run2016Hv3_v1'
