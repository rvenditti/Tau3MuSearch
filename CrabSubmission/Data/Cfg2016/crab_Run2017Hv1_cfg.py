...
config.General.requestName = 'SkimTau3Mu_DoubleMuonLowMass_Run2016H_v1'
...
config.Data.inputDataset = '/DoubleMuonLowMass/Run2016H-PromptReco-v1/AOD'
...
config.Data.outputDatasetTag = 'SkimTau3Mu_DoubleMuonLowMass_Run2016H_v1'
